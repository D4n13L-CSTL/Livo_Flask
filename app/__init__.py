...
def create_app():
    ...
    CORS(app, supports_credentials=True, origins=["http://localhost:5173", "http://localhost:3000", "http://172.0.0.1:5173" , "http://172.0.0.1:3000","http://127.0.0.1:5500","http://localhost:5500","bright-clocks-raise.loca.lt"])
